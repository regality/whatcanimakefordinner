...
~~~sh
git clone git@github.com:nko3/nodo-baggins.git
~~~
...
~~~sh
npm install -g jitsu
jitsu login --username nko3-nodo-baggins --password X5/RiZNDNJkVhCdk
jitsu deploy
~~~
...
~~~html
<iframe src="http://nodeknockout.com/iframe/nodo-baggins" frameborder=0 scrolling=no allowtransparency=true width=115 height=25>
</iframe>
~~~
...
[2]: https://github.com/organizations/nko3/teams/280601
[3]: https://github.com/nko3/nodo-baggins
